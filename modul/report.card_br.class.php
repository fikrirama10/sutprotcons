...
class card {
	...
	public function card($iddiplomat) 
	{
		...
		from v_id_card_w_permit a where a.ID_DIPLOMAT = $iddiplomat and a.TGL_AWAL_CARD = (select max(b.TGL_AWAL_CARD) from cetak_kartu_diplomat b where b.ID_DIPLOMAT = $iddiplomat AND KD_WORKFLOW>=1)";
	...
	public function formattingprint($tgl2) 
	{
		...
		$tempDir = "temp/";
		// $seed = "987654321";
		// $filename = "image-" . md5(time() . $seed) . ".png";
		$filename = "image.png";
		$pngFilePath = $tempDir . $filename;

		$qrContent = 'https://layanandiplomatik.kemlu.go.id/cd?cr='.$this->id_dip;
		...
		//$pngSimpleCode = QRcode::png($qrContent);
		//header( "Content-type: image/png" );
		//$pngSaveImage = imagepng($pngSimpleCode,$pngFilePath);
		//echo $pngSimpleCode ;
		//die;
						...
						<td width="128.5px" >
							<table cellpadding="0" cellspacing="0" border="0"  bordercolor="#000000" >
								...
								<tr>
									...
									$txt .= '</b></td>
									<td width="3px"></td>
									<td width="65px">Dikeluarkan pada<br/><b>' . $tanggal . '</b></td>
									</tr>
							</table>
						</td>
						<td width="20px">
			...
			<table cellpadding="0" cellspacing="0" width="236" border="0">
				...
				<tr>
					...
					<td width="52" align="center">
						<br/><br/>
						<img src="../foto/' . $this->rdata2 [FOTO] . '" border="0" height="72" width="52"/><br/>
						<img src="../foto/ttd/' . $this->rdata3 [FOTO_TTD] . '" border="0" height="16" width="52"/>
					</td>
					<td width="8"></td>
					<td width="83.5">
