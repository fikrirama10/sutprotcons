<?php
	   echo "<a href=?module=rantorIK&act=cari&huruf=A>A</A> |	<a href=?module=rantorIK&act=cari&huruf=B>B</A> |	<a href=?module=rantorIK&act=cari&huruf=C>C</A> |	<a href=?module=rantorIK&act=cari&huruf=D>D</A> |	<a href=?module=rantorIK&act=cari&huruf=E>E</A> |	<a href=?module=rantorIK&act=cari&huruf=F>F</A> |	<a href=?module=rantorIK&act=cari&huruf=G>G</A> |	<a href=?module=rantorIK&act=cari&huruf=H>H</A> |	<a href=?module=rantorIK&act=cari&huruf=I>I</A> |	<a href=?module=rantorIK&act=cari&huruf=J>J</A> |	<a href=?module=rantorIK&act=cari&huruf=K>K</A> |	<a href=?module=rantorIK&act=cari&huruf=L>L</A> |	<a href=?module=rantorIK&act=cari&huruf=M>M</A> |	<a href=?module=rantorIK&act=cari&huruf=N>N</A> |	<a href=?module=rantorIK&act=cari&huruf=O>O</A> |	<a href=?module=rantorIK&act=cari&huruf=P>P</A> |	<a href=?module=rantorIK&act=cari&huruf=Q>Q</A> |	<a href=?module=rantorIK&act=cari&huruf=R>R</A> |	<a href=?module=rantorIK&act=cari&huruf=S>S</A> |	<a href=?module=rantorIK&act=cari&huruf=T>T</A> |	<a href=?module=rantorIK&act=cari&huruf=U>U</A> |	<a href=?module=rantorIK&act=cari&huruf=V>V</A> |	<a href=?module=rantorIK&act=cari&huruf=W>W</A> |	<a href=?module=rantorIK&act=cari&huruf=X>X</A> |	<a href=?module=rantorIK&act=cari&huruf=Y>Y</A> |	<a href=?module=rantorIK&act=cari&huruf=Z>Z</A>";
...
switch($_GET[act]){
  default:		    
		...
		echo "<h2>Approval Rantor Individu Kasubdit <br>$negaranya</h2>
			<form method=get action='./deplu.php?' enctype='multipart/form-data'>
				 <input type=hidden name=module value='rantorIK'>
...
<a href=?module=rantorIK>ALL</a> | <a href=?module=rantorIK&status=1 style=\"color : #B1BF19\">WAITING</a> | <a href=?module=rantorIK&status=2 style=\"color : green\">APPROVED</a> | 
	<a href=?module=rantorIK&status=0 style=\"color : #800000\">REJECTED</a> <BR>

		<form method=POST enctype='multipart/form-data' action='./aksi_rantorIK.php?module=rantorIK&act=update'>
          <table width=100%>
 ...
 where  (negara like '".$neg."%' and NM_DIPLOMAT like '%".$_GET[namadiplomat]."%') and  ST_PERSETUJUAN_K =  ".$_GET[status]." ORDER BY TANGGAL_IZIN,ID_KNT_PERWAKILAN , NM_DIPLOMAT, ID_RANK desc limit $posisi,$batas ");	
 ...
 where  (negara like '".$neg."%' )  ORDER BY TANGGAL_IZIN,ID_KNT_PERWAKILAN , NM_DIPLOMAT, ID_RANK desc limit $posisi,$batas ");	
	...
	if (isset($_GET[status])){
		if (isset($_GET[namadiplomat]))
		{
			$jmldata =mysql_num_rows(mysql_query("select ID_PENGGUNAA_FAS from v_approval_rantori where negara like '".$neg."%' and NM_DIPLOMAT like '%".$_GET[namadiplomat]."%'  and  ST_PERSETUJUAN_K = ".$_GET[status]));
		}else{
			$jmldata =mysql_num_rows(mysql_query("select ID_PENGGUNAA_FAS from v_approval_rantori where negara like '".$neg."%'  and  ST_PERSETUJUAN_K = ".$_GET[status]));
		}
	}else{
		if (isset($_GET[namadiplomat]))
		{
	...
	if (isset($_GET[status])){
	$ilink = "?module=rantorIK&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]&status=$_GET[status]"; }
	else
	{$ilink = "?module=rantorIK&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]"; }
  ...
  case "cari":
    ...
    while($r=mysql_fetch_array($tampil)){
		...
		echo "<tr><td>$no</td>
				...
				&nbsp <a href=?module=rantorIK&negara=$r[NEGARA]>$r[NEGARA] </a></td><td>";
