...
$NM_DIPLOMAT = htmlspecialchars($_POST[NM_DIPLOMAT], ENT_QUOTES);
      ...
      if ($tipe_file != "image/jpeg" AND $tipe_file != "image/pjpeg"){
        ...
        if (!empty($lokasi_file_ttd)){
            ...
            move_uploaded_file($lokasi_file_ttd,"../foto/ttd/$nama_file_unik_ttd");
        	   $sql= "insert into diplomat (ID_NEGARA,ID_RANK,ID_KNT_PERWAKILAN,ID_JNS_PASPOR,ID_JNS_VISA,NM_DIPLOMAT,TEMPAT_LAHIR,TGL_LAHIR,JK,PEKERJAAN,ALAMATLN,ST_SIPIL,NO_PASPOR,PASPOR_OLEH,PASPOR_TGL,AKHIR_BERLAKU,NO_VISA,VISA_OLEH,LAMA_BERDIAM,TGL_TIBA,ALAMATIN,NO_SETKAB,BERLAKUSD,NO_SPONSOR,ST_VISA,NO_SR_SETNEG,LAMA_BERDIAM_BLN,TELP,FOTO,FOTO_TTD,GELAR,KATEGORI_PEMOHON,INPUT_DATE) values ($ID_NEGARA,$ID_RANK,$ID_KNT_PERWAKILAN,$ID_JNS_PASPOR,$ID_JNS_VISA,'$NM_DIPLOMAT','$TEMPAT_LAHIR','$TGL_LAHIR','$JK','$PEKERJAAN','$ALAMATLN','$ST_SIPIL','$NO_PASPOR','$PASPOR_OLEH','$PASPOR_TGL','$AKHIR_BERLAKU','$NO_VISA','$VISA_OLEH',$LAMA_BERDIAM,'$TGL_TIBA','$ALAMATIN','$NO_SETKAB','$BERLAKUSD','$NO_SPONSOR',$ST_VISA,'$NO_SR_SETNEG',$LAMA_BERDIAM_BLN,'$TELP','$nama_file_unik','$nama_file_unik_ttd','$GELAR','$KATEGORI_PEMOHON','$INPUT_DATE')";
		//	   echo $sql; exit;
			$input = mysql_query($sql);
     }
        }else{
             move_uploaded_file($lokasi_file,"../foto/$nama_file_unik");
        	   $input = mysql_query("insert into diplomat (ID_NEGARA,ID_RANK,ID_KNT_PERWAKILAN,ID_JNS_PASPOR,ID_JNS_VISA,NM_DIPLOMAT,TEMPAT_LAHIR,TGL_LAHIR,JK,PEKERJAAN,ALAMATLN,ST_SIPIL,NO_PASPOR,PASPOR_OLEH,PASPOR_TGL,AKHIR_BERLAKU,NO_VISA,VISA_OLEH,LAMA_BERDIAM,TGL_TIBA,ALAMATIN,NO_SETKAB,BERLAKUSD,NO_SPONSOR,ST_VISA,NO_SR_SETNEG,LAMA_BERDIAM_BLN,TELP,FOTO,FOTO_TTD,GELAR,KATEGORI_PEMOHON,INPUT_DATE) values ($ID_NEGARA,$ID_RANK,$ID_KNT_PERWAKILAN,$ID_JNS_PASPOR,$ID_JNS_VISA,'$NM_DIPLOMAT','$TEMPAT_LAHIR','$TGL_LAHIR','$JK','$PEKERJAAN','$ALAMATLN','$ST_SIPIL','$NO_PASPOR','$PASPOR_OLEH','$PASPOR_TGL','$AKHIR_BERLAKU','$NO_VISA','$VISA_OLEH',$LAMA_BERDIAM,'$TGL_TIBA','$ALAMATIN','$NO_SETKAB','$BERLAKUSD','$NO_SPONSOR',$ST_VISA,'$NO_SR_SETNEG',$LAMA_BERDIAM_BLN,'$TELP','$nama_file_unik','','$GELAR','$KATEGORI_PEMOHON','$INPUT_DATE')");
        }
     }
   }
   else{
        if (!empty($lokasi_file_ttd)){
            ...
            move_uploaded_file($lokasi_file_ttd,"../foto/ttd/$nama_file_unik_ttd");
        	   $input = mysql_query("insert into diplomat (ID_NEGARA,ID_RANK,ID_KNT_PERWAKILAN,ID_JNS_PASPOR,ID_JNS_VISA,NM_DIPLOMAT,TEMPAT_LAHIR,TGL_LAHIR,JK,PEKERJAAN,ALAMATLN,ST_SIPIL,NO_PASPOR,PASPOR_OLEH,PASPOR_TGL,AKHIR_BERLAKU,NO_VISA,VISA_OLEH,LAMA_BERDIAM,TGL_TIBA,ALAMATIN,NO_SETKAB,BERLAKUSD,NO_SPONSOR,ST_VISA,NO_SR_SETNEG,LAMA_BERDIAM_BLN,TELP,FOTO,FOTO_TTD,GELAR,KATEGORI_PEMOHON,INPUT_DATE) values ($ID_NEGARA,$ID_RANK,$ID_KNT_PERWAKILAN,$ID_JNS_PASPOR,$ID_JNS_VISA,'$NM_DIPLOMAT','$TEMPAT_LAHIR','$TGL_LAHIR','$JK','$PEKERJAAN','$ALAMATLN','$ST_SIPIL','$NO_PASPOR','$PASPOR_OLEH','$PASPOR_TGL','$AKHIR_BERLAKU','$NO_VISA','$VISA_OLEH',$LAMA_BERDIAM,'$TGL_TIBA','$ALAMATIN','$NO_SETKAB','$BERLAKUSD','$NO_SPONSOR',$ST_VISA,'$NO_SR_SETNEG',$LAMA_BERDIAM_BLN,'$TELP','','$nama_file_unik_ttd','$GELAR','$KATEGORI_PEMOHON','$INPUT_DATE')");
            
            }
        }else{
             $input = mysql_query("insert into diplomat (ID_NEGARA,ID_RANK,ID_KNT_PERWAKILAN,ID_JNS_PASPOR,ID_JNS_VISA,NM_DIPLOMAT,TEMPAT_LAHIR,TGL_LAHIR,JK,PEKERJAAN,ALAMATLN,ST_SIPIL,NO_PASPOR,PASPOR_OLEH,PASPOR_TGL,AKHIR_BERLAKU,NO_VISA,VISA_OLEH,LAMA_BERDIAM,TGL_TIBA,ALAMATIN,NO_SETKAB,BERLAKUSD,NO_SPONSOR,ST_VISA,NO_SR_SETNEG,LAMA_BERDIAM_BLN,TELP,FOTO,FOTO_TTD,GELAR,KATEGORI_PEMOHON,INPUT_DATE) values ($ID_NEGARA,$ID_RANK,$ID_KNT_PERWAKILAN,$ID_JNS_PASPOR,$ID_JNS_VISA,'$NM_DIPLOMAT','$TEMPAT_LAHIR','$TGL_LAHIR','$JK','$PEKERJAAN','$ALAMATLN','$ST_SIPIL','$NO_PASPOR','$PASPOR_OLEH','$PASPOR_TGL','$AKHIR_BERLAKU','$NO_VISA','$VISA_OLEH',$LAMA_BERDIAM,'$TGL_TIBA','$ALAMATIN','$NO_SETKAB','$BERLAKUSD','$NO_SPONSOR',$ST_VISA,'$NO_SR_SETNEG',$LAMA_BERDIAM_BLN,'$TELP','','','$GELAR','$KATEGORI_PEMOHON','$INPUT_DATE')");
        }
  }
...
$NM_DIPLOMAT = htmlspecialchars(str_replace("'","''",$_POST[NM_DIPLOMAT]),ENT_QUOTES);
$TEMPAT_LAHIR = htmlspecialchars(strtoupper($_POST[TEMPAT_LAHIR]),ENT_QUOTES);
$TGL_LAHIR = $_POST[TGL_LAHIR];
$GELAR = $_POST[GELAR];
$JK = $_POST[JK];   
