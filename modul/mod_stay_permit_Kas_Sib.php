<?php
	   //echo "<br><a href=?module=staypermitKasSib&act=cari&huruf=A>A</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=B>B</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=C>C</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=D>D</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=E>E</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=F>F</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=G>G</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=H>H</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=I>I</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=J>J</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=K>K</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=L>L</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=M>M</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=N>N</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=O>O</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=P>P</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=Q>Q</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=R>R</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=S>S</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=T>T</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=U>U</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=V>V</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=W>W</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=X>X</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=Y>Y</A> |	<a href=?module=staypermitKasSib&act=cari&huruf=Z>Z</A>";
//exit;		
...
switch($_GET[act]){
  default:		    
		...
		echo "<h2>Approval Permit Kasie <br>$negaranya</h2>
			<form method=get action='./deplu.php?' enctype='multipart/form-data'>
				 <input type=hidden name=module value='staypermitKasSib'>
				 <input type=hidden name=negara value='$_GET[negara]'>
				Nama Family : <input type=text name=\"namasibling\"> <input type=submit value=Cari>
			</form> <br>

<a href=?module=staypermitKasSib>ALL</a> | <a href=?module=staypermitKasSibSib&status=1 style=\"color : #B1BF19\">WAITING</a> | <a href=?module=staypermitKasSib&status=2 style=\"color : green\">APPROVED</a> | 
	<a href=?module=staypermitKasSib&status=0 style=\"color : #800000\">REJECTED</a> <BR>

		<form method=POST enctype='multipart/form-data' action='./aksi_approval_Kas.php?module=staypermitKasSib&act=update'>
          <table width=100% border=1>
          <tr><th width=30>no</th><th>NO PENDAFTARAN</th><th>NAMA LENGKAP Family</th><th>RELASI</th><th colspan=2 >Negara</th><th width=100>PEKERJAAN FAMILY</th><th>NAMA DIPLOMAT</th><th width=80>TGL BERLAKU</th><th width=40>JNS PERMIT</th><th width=80>TGL AGENDA</th><th width=90>AKSI</th></tr>";
	...
	$tampil=mysql_query("select NO_DAFTAR, ID_PERMIT_S,ID_SIBLING,ID_JNS_PERMIT,NO_AGENDA,date_format(TGL_AGENDA,'%d.%m.%Y') as TGL_AGENDA,NO_IZIN_PERMIT,date_format(TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT,date_format(TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,
KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_SIBLING,ST_PERMIT,ST_PERMIT_K,ST_PERMIT_KAS,PEKERJAAN,NM_DIPLOMAT, BENDERA,NEGARA,NM_JNS_RELASI from v_approval_permit_sib where  (negara like '".$neg."%' and NM_SIBLING like '%".$_GET[namasibling]."%') and  ST_PERMIT_KAS = ".$_GET[status]." order by id_permit_s desc limit $posisi,$batas ");	 
	
	}
	else
    {
	$sql="select NO_DAFTAR, ID_PERMIT_S,ID_SIBLING,ID_JNS_PERMIT,NO_AGENDA,date_format(TGL_AGENDA,'%d.%m.%Y') as TGL_AGENDA,NO_IZIN_PERMIT,date_format(TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT,date_format(TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,
KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_SIBLING,ST_PERMIT,ST_PERMIT_K,ST_PERMIT_KAS,PEKERJAAN,NM_DIPLOMAT, BENDERA,NEGARA,NM_JNS_RELASI from v_approval_permit_sib where  (negara like '".$neg."%')  and KD_WORKFLOW > '0' and  ST_PERMIT_KAS = $_GET[status] order by id_permit_s desc limit $posisi,$batas ";
	...
	ELSE
	{
		if (isset($_GET[namasibling])){
		$tampil=mysql_query("select NO_DAFTAR, ID_PERMIT_S,ID_SIBLING,ID_JNS_PERMIT,NO_AGENDA,date_format(TGL_AGENDA,'%d.%m.%Y') as TGL_AGENDA,NO_IZIN_PERMIT,date_format(TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT,date_format(TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,
KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_SIBLING,ST_PERMIT,ST_PERMIT_K,ST_PERMIT_KAS,PEKERJAAN,NM_DIPLOMAT, BENDERA,NEGARA,NM_JNS_RELASI from v_approval_permit_sib where  negara like '".$neg."%' and NM_SIBLING like '%".$_GET[namasibling]."%'  order by id_permit_s desc limit $posisi,$batas ");	 
	
	
		}
		else
		{$tampil=mysql_query("select NO_DAFTAR, ID_PERMIT_S,ID_SIBLING,ID_JNS_PERMIT,NO_AGENDA,date_format(TGL_AGENDA,'%d.%m.%Y') as TGL_AGENDA,NO_IZIN_PERMIT,date_format(TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT,date_format(TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,
KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_SIBLING,ST_PERMIT,ST_PERMIT_K,ST_PERMIT_KAS,PEKERJAAN,NM_DIPLOMAT, BENDERA,NEGARA,NM_JNS_RELASI from v_approval_permit_sib where  negara like '".$neg."%'  order by id_permit_s desc limit $posisi,$batas ");	
    ...
    while($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td>$no</td>
                <td  >$r[NO_DAFTAR]</td>
				<td><a href=?module=staypermitSib&act=lihat_stay_permit&idt=$r[ID_SIBLING]&negara=$_GET[negara]>$r[NM_SIBLING]</a></td>
				<td  >$r[NM_JNS_RELASI]</td>
				<td width=20><img src=\"../images/bendera/".strtolower($r[BENDERA])."\" class=\"thumbborder\" width=\"22\" height=\"15\" /></td>  
				<td width=120>$r[NEGARA]</td>
				<td>$r[PEKERJAAN]</td>
				<td>$r[NM_DIPLOMAT]</td>
				...
				<td>$r[TGL_AGENDA]</td>
				<td>
				<div style=\"color : #B1BF19\"><input type=radio onClick='checkBox(this.value,$noP)' name='ST_PERMIT_KAS$noP' value=1 ";
					if ($r[ST_PERMIT_KAS]== 1){ echo "checked";}
				echo "> <b>waiting</b> </div><div style=\"color : green\"><input onClick='checkBox(this.value,$noP)' type=radio name='ST_PERMIT_KAS$noP' value=2 ";
					if ($r[ST_PERMIT_KAS]== 2){ echo "checked";}				
				echo "> <b>approve</b> </div> <div style=\"color : #800000\"> <input onClick='checkBox(this.value,$noP)' type=radio name='ST_PERMIT_KAS$noP' value=0 ";
					if ($r[ST_PERMIT_KAS]== 0){ echo "checked";}
				echo "> <b>reject</b> </div>";					
				echo "<div id='popup_box$noP' class='popup_box'>
						<h2>Konfirmasi Status Persetujuan Pengajuan Izin Tinggal</h2>
						<div>
						<table width='100%'>
							<tr>
							...
							<tr>
								<td >Negara</td><td>:</td><td>$r[NEGARA]</td>
							</tr>
							<tr>
								<th width='40%' colspan='3'> </th>
							</tr>
							<tr>
								<td width='40%'>Nama Lengkap Family</td><td width='6'>:</td><td>$r[NM_SIBLING]</td>
							</tr>
							<tr>
						...
						$tampil1=mysql_query("SELECT * FROM syarat_permit a inner join m_syarat b on  a.syarat_kd=b.syarat_kd where b.jenis_izin='2' and a.id_permit='".$r['ID_PERMIT_S']."'");
				...
				while ($data=mysql_fetch_array($tampil1)) {
					...
					$tampil2=mysql_query("select * from m_syarat where jenis_izin='2' and syarat_kd not in ( SELECT b.syarat_kd FROM syarat_permit a inner join m_syarat b on  a.syarat_kd=b.syarat_kd where b.jenis_izin='2' and a.id_permit='".$r['ID_PERMIT_S']."')");
				...
				echo "<tr>
						<td></td>
						<td></td>
						<td><input type='button' name='updateStatus' onClick=updateAction($r[ID_PERMIT_S],$noP,'Kas',2); value='Submit'></td>
					  </tr>";
				//} else {
				//echo "<tr>
	...
	//<div align=right><input type=submit value=Update>
	if (isset($_GET[status])){
		if (isset($_GET[namasibling]))
		{
			$jmldata =mysql_num_rows(mysql_query("select ID_PERMIT_S from v_approval_permit_sib where negara like '".$neg."%' and NM_SIBLING like '%".$_GET[namasibling]."%'  and  ST_PERMIT_KAS = ".$_GET[status]));
		}else{
			$jmldata =mysql_num_rows(mysql_query("select ID_PERMIT_S from v_approval_permit_sib where negara like '".$neg."%'  and  ST_PERMIT_KAS = ".$_GET[status]));
		}
	}else{
		if (isset($_GET[namasibling]))
		{
			$jmldata =mysql_num_rows(mysql_query("select ID_PERMIT_S from v_approval_permit_sib where negara like '".$neg."%' and NM_SIBLING like '%".$_GET[namasibling]."%' "));
		}else{
			$jmldata =mysql_num_rows(mysql_query("select ID_PERMIT_S from v_approval_permit_sib where negara like '".$neg."%'"));
		}
	}
	...
	if (isset($_GET[status])){
	$ilink = "?module=staypermitKasSib&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]&status=$_GET[status]"; }
	else
	{$ilink = "?module=staypermitKasSib&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]"; }
  ...
  case "lihat_stay_permit":
	...
	echo " <input type=button value='Tambah' onclick=location.href='?module=staypermitKasSib&act=tambah_stay_permit&idt=$idt&negara=$_GET[negara]'>
			<table width=100%>
    ...
    while($r=mysql_fetch_array($tampil)){
      echo "<tr><td>$no</td>
                <td><a href=?module=staypermitKasSib&act=edit_stay_permit&idt=$r[ID_PERMIT]&idd=$idt&negara=$_GET[negara]> $r[KD_JNS_PERMIT]</a></td>
				<td>$r[NO_AGENDA]</td>
				<td>$r[TGL_AGENDA]</td>
		...
		if ($r[ST_PERMIT_KAS] == 2){
			...
			echo "<div style=\"color : #800000\"> <b>rejected</b> </div>";
				...
				>Cetak</a> | 
		            <a href=./aksi_stay_permit.php?module=staypermitKasSib&act=hapus&idt=$r[ID_PERMIT]&idd=$idt&negara=$_GET[negara] onClick=\"return confirm('Apakah Anda benar-benar akan menghapus permit $r[NO_IZIN_PERMIT]?')\">Hapus</a></td>
				</tr>";
  ...
  case "cari":
    ...
    while($r=mysql_fetch_array($tampil)){
		...
		echo "<tr><td>$no</td>
				...
				&nbsp <a href=?module=staypermitKasSib&negara=$r[NEGARA]>$r[NEGARA] </a></td><td>";
