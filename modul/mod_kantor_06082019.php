 	...
 	echo "<h2>Edit Kantor Perwakilan</h2>
		...
		<tr><td  width=120>Negara</td>  <td colspan=\"2\"> :
          ...
          $tampil=mysql_query("SELECT ID_SUB_JNS,NM_SUB_JNS FROM m_sub_jns_perwakilan ORDER BY ID_SUB_JNS");
			...
			<tr bgcolor='#ffefb2'><td>Alamat </td>    <td > : <textarea name='alamat' rows=2 cols=50 >$r[ALAMAT]</textarea></td></tr>
          	<tr bgcolor='#ffefb2'><td>Kota</td >  <td > : <input type=text name='kota' value='$r[KOTA]' size=50></td></tr>
          	<tr bgcolor='#ffefb2'><td>Telp</td >  <td > : <input type=text name='telp' value='$r[TELP]' size=50></td></tr>
          	...
          	<tr bgcolor='#ffefb2'><td>Office Hours</td >  <td > : <input type=text name='offhours' value='$r[OFFHOURS]' size=50></td></tr>
			<tr bgcolor='#ffefb2'><td>National Day</td> <td> <DIV id=\"tgl\"> <script>DateInput('nationalday', true, 'YYYY-MM-DD','$dDate')</script></div>
