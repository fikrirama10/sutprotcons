...
class card
{
	...
	/*$sql = $this->rdata2[NM_KNT_PERWAKILAN];
	echo $sql;
	exit;*/
	//echo '<img src="../foto/'.$this->rdata3[FOTO].'" border="0" height="60" width="47"/>&nbsp;&nbsp;&nbsp;';exit;
	...
	public function formattingprint()
	{
		...
		$txt='
			...
			<td colspan="4" align="center" >
				<u><strong>Izin Tinggal / '.$jns_permit.'</strong></u><br />
				Stay Permit / '.$this->rdata[NM_JNS_PERMIT].'
				<!--<u><strong>Izin Tinggal / Izin Keluar Masuk Beberapa Kali Perjalanan</strong></u><br />
				Stay Permit / Multiple Exit Re-Entry Permit -->
		</td>
			  </tr>
