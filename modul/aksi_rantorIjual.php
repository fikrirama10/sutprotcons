...
if ($module=='rantorIjual' AND $act=='batal_rantorIjual' AND isset($_GET[idt])){
...
$NO_KTP_PEMBELI= $_POST[NO_KTP_PEMBELI];
	...
	header('location: ./deplu.php?module='.$module.'&act=lihat_rantorIjual&idt='.$ID_DIPLOMAT.'&negara='.$neg);
