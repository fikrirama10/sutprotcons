...
public function stk_pwk($negara,$perwakilan, $tglaju1, $tglaju2, $setuju, $tolak){
...
$txt=' 
			  ...
			  <tr>
				<td colspan="9" align="center">
					<u><strong>STATISTIK PENGAJUAN BEBAS BEA BAGI KANTOR PERWAKILAN ASING</strong></u><br />
					DIREKTORAT FASILITAS DIPLOMATIK<br/>
                          ...
                          <tr>
                          <td colspan="9">
                          <i>Data berdasarkan hasil pencarian : '.$tgl_pengajuan_rpt.''.$negara_rpt.''.$knt_perwakilan.''.$setuju_tolak.'</i></td></tr>
