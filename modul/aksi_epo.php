	...
	if ($module=='epo' AND $act=='input') {
		...
		function sendemail($nodaftar,$nama,$email,$kd_flow,$ket,$tgl_ambil)
		{
				...
				<html>
					...
					<body>
						...
						<p>
							Yth. Pemohon,
							<br/>
							Permohonan atas nama : <strong>$nama</strong> dengan nomor registrasi : <strong>$nodaftar</strong> telah disetujui, mohon agar dapat menyerahkan berkas ke loket Konsuler pada tanggal $tgl_ambil.
						</p>
						Terima kasih
						<br/>
						==============================================
						<p>
							To The Applicant,
							<br/>
							Your application with the registration number : <strong>$nodaftar</strong> for <strong>$nama</strong> has been verified, kindly submit the original documents to the consular counter on this date $tgl_ambil.
						</p>
						Thank you.
						<br/>
						<p>
			...
			if ($kd_flow == 2) {
				...
				$noreg1  = $nodaftar;
				$subject_temp = 'Konfirmasi Izin Keluar No. Daftar / Exit Permit Only (EPO) Reg. No : '.$noreg1.' (DIPLOMAT) Disetujui / Approved';
				$subject = $subject_temp;
			} elseif ($kd_flow == 1) {
				$message = $messagetolak;
				$noreg1  = $nodaftar;
				$subject = 'Konfirmasi Izin Keluar No. Daftar / Exit Permit Only (EPO) Reg. No : '.$noreg1.' (DIPLOMAT) Ditolak / Rejected';
			}	
