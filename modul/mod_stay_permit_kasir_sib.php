<?php
	   echo "<a href=?module=staypermitKasirSib&act=cari&huruf=A>A</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=B>B</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=C>C</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=D>D</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=E>E</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=F>F</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=G>G</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=H>H</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=I>I</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=J>J</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=K>K</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=L>L</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=M>M</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=N>N</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=O>O</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=P>P</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=Q>Q</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=R>R</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=S>S</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=T>T</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=U>U</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=V>V</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=W>W</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=X>X</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=Y>Y</A> |	<a href=?module=staypermitKasirSib&act=cari&huruf=Z>Z</A>";
...
switch($_GET[act]){
  default:		    
		...
		echo "<h2>Stay Permit Sibling<br>Pilih  Sibling - $negaranya</h2>
			<form method=get action='./deplu.php?' enctype='multipart/form-data'>
				 <input type=hidden name=module value='staypermitKasirSib'>
			...
			<a href=?module=staypermitKasirSib>ALL</a> | <a href=?module=staypermitKasirSib&status=1 style=\"color : #B1BF19\">WAITING</a> | <a href=?module=staypermitKasirSib&status=2 style=\"color : green\">APPROVED</a> | 
	<a href=?module=staypermitKasirSib&status=0 style=\"color : #800000\">REJECTED</a> <BR>

		<table width=100%>
          <tr><th width=30>no</th><th>NAMA LENGKAP</th><th colspan=2 >KANTOR PERWAKILAN</th><th width=100>JABATAN</th><th width=80>TGL BERLAKU</th><th width=40>JNS PERMIT</th><th width=80>TGL AGENDA</th><th width=45>D</th><th width=45>K</th></tr>";
	...
	$tampil=mysql_query("select a.id_permit,b.ID_DIPLOMAT,b.NM_DIPLOMAT,b.NM_KNT_PERWAKILAN,b.PEKERJAAN, a.NO_IZIN_PERMIT, date_format(a.TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT ,date_format(a.TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,a.KD_JNS_PERMIT,a.NM_JNS_PERMIT,a.ST_PERMIT,a.ST_PERMIT_K,a.BENDERA,a.NEGARA,a.TGL_AGENDA  from v_approval_permit a right join v_diplomat b on a.id_diplomat=b.id_diplomat where  b.negara like '".$neg."%' and b.NM_DIPLOMAT like '%".$_GET[namadiplomat]."%' and  (a.ST_PERMIT_K = ".$_GET[status]."  or a.ST_PERMIT = ".$_GET[status].") order by id_permit desc limit $posisi,$batas ");	

	}
	else
    {	
		$tampil=mysql_query("select a.id_permit,b.ID_DIPLOMAT,b.NM_DIPLOMAT,b.NM_KNT_PERWAKILAN,b.PEKERJAAN, a.NO_IZIN_PERMIT, date_format(a.TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT ,date_format(a.TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,a.KD_JNS_PERMIT,a.NM_JNS_PERMIT,a.ST_PERMIT,a.ST_PERMIT_K,a.BENDERA,a.NEGARA,a.TGL_AGENDA from v_approval_permit a right join v_diplomat b on a.id_diplomat=b.id_diplomat  where  b.negara like '".$neg."%'  and  (a.ST_PERMIT_K = ".$_GET[status]."  or a.ST_PERMIT = ".$_GET[status].")  order by id_permit desc limit $posisi,$batas ");
	
	}//if (isset($_GET[namadiplomat]))

	}else{
	if (isset($_GET[namadiplomat])){
	$tampil=mysql_query("select a.id_permit,b.ID_DIPLOMAT,b.NM_DIPLOMAT,b.NM_KNT_PERWAKILAN,b.PEKERJAAN, a.NO_IZIN_PERMIT, date_format(a.TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT ,date_format(a.TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,a.KD_JNS_PERMIT,a.NM_JNS_PERMIT,a.ST_PERMIT,a.ST_PERMIT_K,a.BENDERA,a.NEGARA,a.TGL_AGENDA  from v_approval_permit a right join v_diplomat b on a.id_diplomat=b.id_diplomat where  b.negara like '".$neg."%' and b.NM_DIPLOMAT like '%".$_GET[namadiplomat]."%'  order by id_permit desc limit $posisi,$batas ");	 	
	
	}
	else
    {	
		$tampil=mysql_query("select a.id_permit,b.ID_DIPLOMAT,b.NM_DIPLOMAT,b.NM_KNT_PERWAKILAN,b.PEKERJAAN, a.NO_IZIN_PERMIT, date_format(a.TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT ,date_format(a.TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,a.KD_JNS_PERMIT,a.NM_JNS_PERMIT,a.ST_PERMIT,a.ST_PERMIT_K,a.BENDERA,a.NEGARA,a.TGL_AGENDA from v_approval_permit a right join v_diplomat b on a.id_diplomat=b.id_diplomat  where  b.negara like '".$neg."%'  order by id_permit desc limit $posisi,$batas ");
    ...
    while($r=mysql_fetch_array($tampil)){
      echo "<tr><td>$no</td>
                <td><a href=?module=staypermitKasirSib&act=lihat_stay_permit&idt=$r[ID_DIPLOMAT]&negara=$_GET[negara]>$r[NM_DIPLOMAT]</a></td>
	...
	if (isset($_GET[status])){
	$ilink = "?module=staypermitKasirSib&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]&status=$_GET[status]"; }
	else
	{$ilink = "?module=staypermitKasirSib&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]"; }
  ...
  case "lihat_stay_permit":
	...
	echo " <input type=button value='Tambah' onclick=location.href='?module=staypermitKasirSib&act=tambah_stay_permit&idt=$idt&negara=$_GET[negara]'>
			<table width=100%>
          <tr><th  width=30>no</th><th width=50>Jenis Permit</th><th  width=70>No Agenda</th><th width=85>Tanggal Agenda</th><th width=70>No Izin Permit</th><th width=85>Tanggal Awal Permit</th><th width=85>Tanggal Akhir</th><th>Status Direktur</th><th>Status Kasubdit</th></tr>"; 
    ...
    while($r=mysql_fetch_array($tampil)){
      echo "<tr><td>$no</td>
                <td><a href=?module=staypermitKasirSib&act=edit_stay_permit&idt=$r[ID_PERMIT]&idd=$idt&negara=$_GET[negara]> $r[KD_JNS_PERMIT]</a></td>
				<td>$r[NO_AGENDA]</td>
				<td>$r[TGL_AGENDA]</td>
 ...
 case "tambah_stay_permit":
  ...
  $input = mysql_query("select ID_DIPLOMAT,ID_NEGARA,ID_KNT_PERWAKILAN,ID_JNS_PASPOR,ID_JNS_VISA,NM_DIPLOMAT,TEMPAT_LAHIR,DATE_FORMAT(TGL_LAHIR,'%d %M %Y') AS TGL_LAHIR,JK,FOTO,PEKERJAAN,ALAMATLN,ST_SIPIL,NO_PASPOR,PASPOR_OLEH,DATE_FORMAT(PASPOR_TGL,'%d %M %Y') AS PASPOR_TGL,DATE_FORMAT(AKHIR_BERLAKU,'%d %M %Y') AS AKHIR_BERLAKU,NO_VISA,VISA_OLEH,LAMA_BERDIAM,DATE_FORMAT(TGL_TIBA,'%d %M %Y') AS TGL_TIBA,ALAMATIN,NO_SETKAB,DATE_FORMAT(BERLAKUSD,'%d-%M-%Y') AS BERLAKUSD,NO_SPONSOR,ST_VISA from diplomat where ID_DIPLOMAT = $idt  ");
	...
	echo "<form method=POST enctype='multipart/form-data' action='./aksi_stay_permit_kasir_sib.php?module=staypermitKasirSib&act=input&negara=$_GET[negara]'>
 ...
 case "edit_stay_permit":
  ...
  $input = mysql_query("select ID_DIPLOMAT,ID_NEGARA,ID_KNT_PERWAKILAN,ID_JNS_PASPOR,ID_JNS_VISA,NM_DIPLOMAT,TEMPAT_LAHIR,DATE_FORMAT(TGL_LAHIR,'%d %M %Y') AS TGL_LAHIR,JK,FOTO,PEKERJAAN,ALAMATLN,ST_SIPIL,NO_PASPOR,PASPOR_OLEH,DATE_FORMAT(PASPOR_TGL,'%d %M %Y') AS PASPOR_TGL,DATE_FORMAT(AKHIR_BERLAKU,'%d %M %Y') AS AKHIR_BERLAKU,NO_VISA,VISA_OLEH,LAMA_BERDIAM,DATE_FORMAT(TGL_TIBA,'%d %M %Y') AS TGL_TIBA,ALAMATIN,NO_SETKAB,DATE_FORMAT(BERLAKUSD,'%d-%M-%Y') AS BERLAKUSD,NO_SPONSOR,ST_VISA from diplomat where ID_DIPLOMAT = $idd  ");
	...
	echo "<form method=POST enctype='multipart/form-data' action='./aksi_stay_permit_kasir_sib.php?module=staypermitKasirSib&act=update&idt=$idt&negara=$_GET[negara]'>
          <input type=hidden name=ID_DIPLOMAT value='$r[ID_DIPLOMAT]'>
  ...
  case "cari":
    ...
    while($r=mysql_fetch_array($tampil)){
		...
		echo "<tr><td>$no</td>
				...
				&nbsp <a href=?module=staypermitKasirSib&negara=$r[NEGARA]>$r[NEGARA] </a></td><td>";
