<?php
	   //echo "<a href=?module=staypermitKas&act=cari&huruf=A>A</A> |	<a href=?module=staypermitKas&act=cari&huruf=B>B</A> |	<a href=?module=staypermitKas&act=cari&huruf=C>C</A> |	<a href=?module=staypermitKas&act=cari&huruf=D>D</A> |	<a href=?module=staypermitKas&act=cari&huruf=E>E</A> |	<a href=?module=staypermitKas&act=cari&huruf=F>F</A> |	<a href=?module=staypermitKas&act=cari&huruf=G>G</A> |	<a href=?module=staypermitKas&act=cari&huruf=H>H</A> |	<a href=?module=staypermitKas&act=cari&huruf=I>I</A> |	<a href=?module=staypermitKas&act=cari&huruf=J>J</A> |	<a href=?module=staypermitKas&act=cari&huruf=K>K</A> |	<a href=?module=staypermitKas&act=cari&huruf=L>L</A> |	<a href=?module=staypermitKas&act=cari&huruf=M>M</A> |	<a href=?module=staypermitKas&act=cari&huruf=N>N</A> |	<a href=?module=staypermitKas&act=cari&huruf=O>O</A> |	<a href=?module=staypermitKas&act=cari&huruf=P>P</A> |	<a href=?module=staypermitKas&act=cari&huruf=Q>Q</A> |	<a href=?module=staypermitKas&act=cari&huruf=R>R</A> |	<a href=?module=staypermitKas&act=cari&huruf=S>S</A> |	<a href=?module=staypermitKas&act=cari&huruf=T>T</A> |	<a href=?module=staypermitKas&act=cari&huruf=U>U</A> |	<a href=?module=staypermitKas&act=cari&huruf=V>V</A> |	<a href=?module=staypermitKas&act=cari&huruf=W>W</A> |	<a href=?module=staypermitKas&act=cari&huruf=X>X</A> |	<a href=?module=staypermitKas&act=cari&huruf=Y>Y</A> |	<a href=?module=staypermitKas&act=cari&huruf=Z>Z</A>";
  ...
  default:		    
		...
		echo "<h2>Approval Permit Kasie <br>$negaranya</h2>
			<form method=get action='./deplu.php?' enctype='multipart/form-data'>
				 <input type=hidden name=module value='staypermitKas'>
...
<a href=?module=staypermitKas>ALL</a> | <a href=?module=staypermitKas&status=1 style=\"color : #B1BF19\">WAITING</a> | <a href=?module=staypermitKas&status=2 style=\"color : green\">APPROVED</a> | 
	<a href=?module=staypermitKas&status=0 style=\"color : #800000\">REJECTED</a> <BR>

		<form method=POST enctype='multipart/form-data' action='./aksi_approval_Kas.php?module=staypermitKas&act=update'>
          <table width=100%>
...
KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_DIPLOMAT,ST_PERMIT,ST_PERMIT_K,ST_PERMIT_KAS,PEKERJAAN,NM_KNT_PERWAKILAN, BENDERA,NEGARA from v_approval_permit where  (negara like '".$neg."%' and NM_DIPLOMAT like '%".$_GET[namadiplomat]."%') and  ST_PERMIT_KAS = ".$_GET[status]." order by id_permit desc limit $posisi,$batas ");	 
	
	}
	else
    {$tampil=mysql_query("select NO_DAFTAR, ID_PERMIT,ID_DIPLOMAT,ID_JNS_PERMIT,NO_AGENDA,date_format(TGL_AGENDA,'%d.%m.%Y') as TGL_AGENDA,NO_IZIN_PERMIT,date_format(TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT,date_format(TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,
KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_DIPLOMAT,ST_PERMIT,ST_PERMIT_K,ST_PERMIT_KAS,PEKERJAAN,NM_KNT_PERWAKILAN, BENDERA,NEGARA from v_approval_permit where  (negara like '".$neg."%') and KD_WORKFLOW > '0' and  ST_PERMIT_KAS = $_GET[status] order by id_permit desc limit $posisi,$batas ");	
	...
	ELSE
	{
		if (isset($_GET[namadiplomat])){
		$tampil=mysql_query("select NO_DAFTAR, ID_PERMIT,ID_DIPLOMAT,ID_JNS_PERMIT,NO_AGENDA,date_format(TGL_AGENDA,'%d.%m.%Y') as TGL_AGENDA,NO_IZIN_PERMIT,date_format(TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT,date_format(TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,
	KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_DIPLOMAT,ST_PERMIT,ST_PERMIT_K,ST_PERMIT_KAS,PEKERJAAN,NM_KNT_PERWAKILAN, BENDERA,NEGARA from v_approval_permit where  negara like '".$neg."%' and NM_DIPLOMAT like '%".$_GET[namadiplomat]."%'  order by id_permit desc limit $posisi,$batas ");	 
	
	
		}
		else
		{$tampil=mysql_query("select NO_DAFTAR, ID_PERMIT,ID_DIPLOMAT,ID_JNS_PERMIT,NO_AGENDA,date_format(TGL_AGENDA,'%d.%m.%Y') as TGL_AGENDA,NO_IZIN_PERMIT,date_format(TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT,date_format(TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,
	KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_DIPLOMAT,ST_PERMIT,ST_PERMIT_K,ST_PERMIT_KAS,PEKERJAAN,NM_KNT_PERWAKILAN, BENDERA,NEGARA from v_approval_permit where  negara like '".$neg."%'  order by id_permit desc limit $posisi,$batas ");	
    ...
    while($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td>$no</td>
				...
				echo "<tr>
						<td></td>
						<td></td>
						<td><input type='button' name='updateStatus' onClick=updateAction($r[ID_PERMIT],$noP,'Kas',1); value='Submit'></td>
					  </tr>";
...
*/
	...
	if (isset($_GET[status])){
		if (isset($_GET[namadiplomat]))
		{
			$jmldata =mysql_num_rows(mysql_query("select ID_PERMIT from v_approval_permit where negara like '".$neg."%' and NM_DIPLOMAT like '%".$_GET[namadiplomat]."%'  and  ST_PERMIT_KAS = ".$_GET[status]));
		}else{
			$jmldata =mysql_num_rows(mysql_query("select ID_PERMIT from v_approval_permit where negara like '".$neg."%'  and  ST_PERMIT_KAS = ".$_GET[status]));
		}
	}else{
		if (isset($_GET[namadiplomat]))
		{
	...
	if (isset($_GET[status])){
	$ilink = "?module=staypermitKas&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]&status=$_GET[status]"; }
	else
	{$ilink = "?module=staypermitKas&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]"; }
  ...
  case "lihat_stay_permit":
	...
	echo " <input type=button value='Tambah' onclick=location.href='?module=staypermitKas&act=tambah_stay_permit&idt=$idt&negara=$_GET[negara]'>
			<table width=100%>
    ...
    while($r=mysql_fetch_array($tampil)){
      echo "<tr><td>$no</td>
                <td><a href=?module=staypermitKas&act=edit_stay_permit&idt=$r[ID_PERMIT]&idd=$idt&negara=$_GET[negara]> $r[KD_JNS_PERMIT]</a></td>
				<td>$r[NO_AGENDA]</td>
				<td>$r[TGL_AGENDA]</td>
		...
		if ($r[ST_PERMIT_KAS] == 2){
			...
			echo "<div style=\"color : #800000\"> <b>rejected</b> </div>";
				...
				>Cetak</a> | 
		            <a href=./aksi_stay_permit.php?module=staypermitKas&act=hapus&idt=$r[ID_PERMIT]&idd=$idt&negara=$_GET[negara] onClick=\"return confirm('Apakah Anda benar-benar akan menghapus permit $r[NO_IZIN_PERMIT]?')\">Hapus</a></td>
				</tr>";
  ...
  case "cari":
    ...
    while($r=mysql_fetch_array($tampil)){
		...
		echo "<tr><td>$no</td>
				...
				&nbsp <a href=?module=staypermitKas&negara=$r[NEGARA]>$r[NEGARA] </a></td><td>";
