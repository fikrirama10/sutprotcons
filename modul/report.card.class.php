		...
		if ($_POST ['opsi'] == 'kartu') {
			$txt = '
		 	...
		 	<tr>
					...
					<img src="../foto/' . $this->rdata2 [FOTO] . '" border="0" height="75" width="59"/>
					  <br/> <br/> <img src="../foto/ttd/' . $this->rdata3 [FOTO_TTD] . '" border="0" height="17" width="50"/>
					</td>
					<td width="1px">
					</td>
					<td width="185px" >
					<table cellpadding="0" cellspacing="0" border="0"  bordercolor="#000000" >
						<tr>
							...
							<td width="5px">: </td>
							<td width="110px"> <b>' . $this->rdata [ID_CARD] . '</b></td>
						</tr>
						<tr>
							<td width="52px">Nama</td>
							<td width="5px">: </td>
							<td width="110px">' .ucwords ( strtolower ( $this->rdata [NM_DIPLOMAT])). '</td>
						</tr>
						<tr>
					...
					<table cellpadding="0" cellspacing="0" border="0"  bordercolor="#000000" >
						...
						<tr>
							<td></td>
							<td align=right><font size="5px">Jakarta, ' . $tanggal . '&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </font></td>
						</tr>
						<tr>
							<td width="80px"> </td>
							<td width="92px" align="center">&nbsp;</td>
						</tr>
						<tr>
							<td width="96px" >  </td>
			...
			$txt = '
				<p>&nbsp;</p>
				<br/><br/><br/>
				<table cellpadding="0" style="font-weight:bold;" cellspacing="0" width="240px" border="0" >
				<tr>
					<td colspan="3" align="center"></td>
				</tr>
				<tr>
				...
				<tr>
					<td width="70px" style= "padding : 0;" align=left>&nbsp;
					<img src="../foto/' . $this->rdata2 [FOTO] . '" border="0" height="75" width="59"/>
					  <br/> <br/>
					&nbsp;
							<img src="../foto/ttd/' . $this->rdata3 [FOTO_TTD] . '" border="0" height="17" width="50"/>
					</td>
					<td width="7px">
					</td>
					<td width="185px" >
					...
					<table cellpadding="0" cellspacing="0" border="0"  bordercolor="#000000" >
						...
						<tr>
							<td width="80px"> </td>
							<td width="92px" align="center">Jakarta, &nbsp; &nbsp; ' .  $nama_bln [$month] . " " . $part [0] . '</td>
						</tr>
						<tr>
							<td width="80px"> </td>
							<td width="92px" align="center">&nbsp;</td>
						...
						<tr>
							...
							<td width="105px" >  </td>
							<td width="95px" align="left"><font size="5px"> </font></td>
						</tr>
						</table>
