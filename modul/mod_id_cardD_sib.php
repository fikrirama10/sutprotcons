<?php
	   echo "<br><a href=?module=idcardDSib&act=cari&huruf=A>A</A> |	<a href=?module=idcardDSib&act=cari&huruf=B>B</A> |	<a href=?module=idcardDSib&act=cari&huruf=C>C</A> |	<a href=?module=idcardDSib&act=cari&huruf=D>D</A> |	<a href=?module=idcardDSib&act=cari&huruf=E>E</A> |	<a href=?module=idcardDSib&act=cari&huruf=F>F</A> |	<a href=?module=idcardDSib&act=cari&huruf=G>G</A> |	<a href=?module=idcardDSib&act=cari&huruf=H>H</A> |	<a href=?module=idcardDSib&act=cari&huruf=I>I</A> |	<a href=?module=idcardDSib&act=cari&huruf=J>J</A> |	<a href=?module=idcardDSib&act=cari&huruf=K>K</A> |	<a href=?module=idcardDSib&act=cari&huruf=L>L</A> |	<a href=?module=idcardDSib&act=cari&huruf=M>M</A> |	<a href=?module=idcardDSib&act=cari&huruf=N>N</A> |	<a href=?module=idcardDSib&act=cari&huruf=O>O</A> |	<a href=?module=idcardDSib&act=cari&huruf=P>P</A> |	<a href=?module=idcardDSib&act=cari&huruf=Q>Q</A> |	<a href=?module=idcardDSib&act=cari&huruf=R>R</A> |	<a href=?module=idcardDSib&act=cari&huruf=S>S</A> |	<a href=?module=idcardDSib&act=cari&huruf=T>T</A> |	<a href=?module=idcardDSib&act=cari&huruf=U>U</A> |	<a href=?module=idcardDSib&act=cari&huruf=V>V</A> |	<a href=?module=idcardDSib&act=cari&huruf=W>W</A> |	<a href=?module=idcardDSib&act=cari&huruf=X>X</A> |	<a href=?module=idcardDSib&act=cari&huruf=Y>Y</A> |	<a href=?module=idcardDSib&act=cari&huruf=Z>Z</A>";
...
switch($_GET[act]){
  default:		    
		...
		echo "<h2>Approval ID CARD Sibling Direktur <br>$negaranya</h2>
			<form method=get action='./deplu.php?' enctype='multipart/form-data'>
				 <input type=hidden name=module value='idcardDSib'>
...
<a href=?module=idcardDSib>ALL</a> | <a href=?module=idcardDSib&status=1 style=\"color : #B1BF19\">WAITING</a> | <a href=?module=idcardDSib&status=2 style=\"color : green\">APPROVED</a> | 
	<a href=?module=idcardDSib&status=0 style=\"color : #800000\">REJECTED</a> <BR>

		<form method=POST enctype='multipart/form-data' action='./aksi_id_cardD_sib.php?module=idcardDSib&act=update'>
          <table width=100%>
	...
	$tampil=mysql_query("select a.NM_JNS_CETAK_KARTU,a.ID_CETAK_S,a.ID_CARD,a.ID_DIPLOMAT,a.NM_DIPLOMAT,c.ID_SIBLING,c.NM_SIBLING,c.PEKERJAAN,c.NM_KNT_PERWAKILAN, c.NM_JNS_RELASI,date_format(a.TGL_AWAL_CARD,'%d.%m.%Y') as TGL_AWAL_CARD,  date_format(a.TGL_AKHIR_CARD,'%d.%m.%Y') as TGL_AKHIR_CARD, a.ST_KARTU,a.ST_KARTU_K  from v_id_card_s a LEFT join v_sibling c on a.ID_SIBLING=c.ID_SIBLING  where c.NEGARA like '%$neg%'  and  a.ST_KARTU =  ".$_GET[status]." ORDER BY a.TGL_AKHIR_CARD , NM_DIPLOMAT desc limit $posisi,$batas ");
	...
	ELSE
	{
		...
		$tampil=mysql_query("select a.NM_JNS_CETAK_KARTU,a.ID_CETAK_S,a.ID_CARD,a.ID_DIPLOMAT,a.NM_DIPLOMAT,c.ID_SIBLING,c.NM_SIBLING,c.PEKERJAAN,c.NM_KNT_PERWAKILAN, c.NM_JNS_RELASI,date_format(a.TGL_AWAL_CARD,'%d.%m.%Y') as TGL_AWAL_CARD,  date_format(a.TGL_AKHIR_CARD,'%d.%m.%Y') as TGL_AKHIR_CARD, a.ST_KARTU,a.ST_KARTU_K  from v_id_card_s a  LEFT  JOIN v_sibling c on a.ID_SIBLING=c.ID_SIBLING   where c.NM_DIPLOMAT like '%".$_GET[namadiplomat]."%' and c.NEGARA like '%$neg%'  ORDER BY a.TGL_AKHIR_CARD, NM_DIPLOMAT desc limit $posisi,$batas");
	
		}
		else
		{
 
 	$tampil=mysql_query("select a.NM_JNS_CETAK_KARTU,a.ID_CETAK_S,a.ID_CARD,a.ID_DIPLOMAT,a.NM_DIPLOMAT,c.ID_SIBLING,c.NM_SIBLING,c.PEKERJAAN,c.NM_KNT_PERWAKILAN, c.NM_JNS_RELASI,date_format(a.TGL_AWAL_CARD,'%d.%m.%Y') as TGL_AWAL_CARD,  date_format(a.TGL_AKHIR_CARD,'%d.%m.%Y') as TGL_AKHIR_CARD, a.ST_KARTU,a.ST_KARTU_K  from v_id_card_s a LEFT join v_sibling c on a.ID_SIBLING=c.ID_SIBLING   where  c.NEGARA like '%$neg%' ORDER BY a.TGL_AKHIR_CARD, NM_DIPLOMAT desc limit $posisi,$batas");
    ...
    while($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td>$no</td>
				...
				<td>
				<div style=\"color : #B1BF19\"><input type=radio onClick='checkBox(this.value,$noP)' name='ST_KARTU$noP' value=1 ";
					if ($r[ST_KARTU]== 1){ echo "checked";}
				echo "> <b>waiting</b> </div><div style=\"color : green\"><input onClick='checkBox(this.value,$noP)' type=radio name='ST_KARTU$noP' value=2 ";
					if ($r[ST_KARTU]== 2){ echo "checked";}				
				echo "> <b>approve</b> </div> <div style=\"color : #800000\"> <input onClick='checkBox(this.value,$noP)' type=radio name='ST_KARTU$noP' value=0 ";
				...
				echo "<tr>
						<td></td>
						<td></td>
						<td><input type='button' name='updateStatus' onClick=updateAction($r[ID_CETAK_S],$noP,'D','4'); value='Submit'></td>
					  </tr>";
...
*/				echo "  
				...
				<input type=hidden name='ID_CETAK_S$noP' value='$r[ID_CETAK_S]'>     	  
		        </tr>";
      $no++;
	  $noP++;
    }
	...
	if (isset($_GET[status])){
		if (isset($_GET[namadiplomat]))
		{
			...
			$jmldata =mysql_num_rows(mysql_query("SELECT a.ID_CETAK_S  from v_id_card_s a LEFT join v_sibling c on a.ID_SIBLING=c.ID_SIBLING  where  (c.negara like '".$neg."%' and c.NM_DIPLOMAT like '%".$_GET[namadiplomat]."%') and  a.ST_KARTU =  ".$_GET[status]));

		
		}else{

			$jmldata =mysql_num_rows(mysql_query("SELECT a.ID_CETAK_S  from v_id_card_s a LEFT join v_sibling c on a.ID_SIBLING=c.ID_SIBLING where  (c.negara like '".$neg."%') and  a.ST_KARTU =  ".$_GET[status]));
	...
	if (isset($_GET[status])){
	$ilink = "?module=idcardDSib&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]&status=$_GET[status]"; }
	else
	{$ilink = "?module=idcardDSib&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]"; }
  ...
  case "cari":
	...
	echo "<h2>Approval ID CARD Sibling Direktur - Pilih Negara</h2> 
	<table width=100%>
    ...
    while($r=mysql_fetch_array($tampil)){
		...
		echo "<tr><td>$no</td>
				...
				&nbsp <a href=?module=idcardDSib&negara=$r[NEGARA]>$r[NEGARA] </a></td><td>";
