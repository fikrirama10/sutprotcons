...
if (empty($_GET[namadiplomat])){
	...
	else if (((isset($_GET[namadiplomat])) and (empty ($_GET[kantordiplomat])) and (empty($_GET[jabatandiplomat]))) and ((empty($_GET[namadiplomat])) and (empty($_GET[kantordiplomat])) and (empty($_GET[jabatandiplomat])))){
	...
	else if (((isset($_GET[kantordiplomat])) and (empty ($_GET[namadiplomat])) and (empty($_GET[jabatandiplomat]))) and ((empty($_GET[namadiplomat])) and (empty($_GET[kantordiplomat])) and (empty($_GET[jabatandiplomat])))){
...
if (empty($_GET[jabatandiplomat])){
	...
	else if (((isset($_GET[jabatandiplomat])) and (empty ($_GET[namadiplomat])) and (empty($_GET[kantordiplomat]))) and ((empty($_GET[namadiplomat])) and (empty($_GET[kantordiplomat])) and (empty($_GET[jabatandiplomat])))){
...
else if (((isset($_GET[namadiplomat])) and (isset($_GET[kantordiplomat])) and (empty($_GET[jabatandiplomat]))) and ((empty($_GET[namadiplomat])) and (empty($_GET[kantordiplomat])) and (empty($_GET[jabatandiplomat])))){
...
else if (((isset($_GET[namadiplomat])) and (isset($_GET[jabatandiplomat])) and (empty($_GET[kantordiplomat]))) and ((empty($_GET[namadiplomat])) and (empty($_GET[kantordiplomat])) and (empty($_GET[jabatandiplomat])))){
...
else if (((isset($_GET[kantordiplomat])) and (isset($_GET[jabatandiplomat])) and (empty($_GET[namadiplomat]))) and ((empty($_GET[namadiplomat])) and (empty($_GET[kantordiplomat])) and (empty($_GET[jabatandiplomat])))){
