...
<?php
	   echo "<br><a href=?module=staypermitD&act=cari&huruf=A>A</A> |	<a href=?module=staypermitD&act=cari&huruf=B>B</A> |	<a href=?module=staypermitD&act=cari&huruf=C>C</A> |	<a href=?module=staypermitD&act=cari&huruf=D>D</A> |	<a href=?module=staypermitD&act=cari&huruf=E>E</A> |	<a href=?module=staypermitD&act=cari&huruf=F>F</A> |	<a href=?module=staypermitD&act=cari&huruf=G>G</A> |	<a href=?module=staypermitD&act=cari&huruf=H>H</A> |	<a href=?module=staypermitD&act=cari&huruf=I>I</A> |	<a href=?module=staypermitD&act=cari&huruf=J>J</A> |	<a href=?module=staypermitD&act=cari&huruf=K>K</A> |	<a href=?module=staypermitD&act=cari&huruf=L>L</A> |	<a href=?module=staypermitD&act=cari&huruf=M>M</A> |	<a href=?module=staypermitD&act=cari&huruf=N>N</A> |	<a href=?module=staypermitD&act=cari&huruf=O>O</A> |	<a href=?module=staypermitD&act=cari&huruf=P>P</A> |	<a href=?module=staypermitD&act=cari&huruf=Q>Q</A> |	<a href=?module=staypermitD&act=cari&huruf=R>R</A> |	<a href=?module=staypermitD&act=cari&huruf=S>S</A> |	<a href=?module=staypermitD&act=cari&huruf=T>T</A> |	<a href=?module=staypermitD&act=cari&huruf=U>U</A> |	<a href=?module=staypermitD&act=cari&huruf=V>V</A> |	<a href=?module=staypermitD&act=cari&huruf=W>W</A> |	<a href=?module=staypermitD&act=cari&huruf=X>X</A> |	<a href=?module=staypermitD&act=cari&huruf=Y>Y</A> |	<a href=?module=staypermitD&act=cari&huruf=Z>Z</A>";
...
switch($_GET[act]){
  default:		    
		...
		echo "<h2>Approval Permit Direktur <br>$negaranya</h2>
			<form method=get action='./deplu.php?' enctype='multipart/form-data'>
				 <input type=hidden name=module value='staypermitD'>
...
<a href=?module=staypermitD>ALL</a> | <a href=?module=staypermitD&status=1 style=\"color : #B1BF19\">WAITING</a> | <a href=?module=staypermitD&status=2 style=\"color : green\">APPROVED</a> | 
	<a href=?module=staypermitD&status=0 style=\"color : #800000\">REJECTED</a> <BR>

		<form method=POST enctype='multipart/form-data' action='./aksi_approval_D.php?module=staypermitD&act=update'>
          <table width=100%>
          <tr><th width=30>no</th><th>NAMA LENGKAP</th><th colspan=2 >KANTOR PERWAKILAN</th><th width=100>JABATAN</th><th width=80>TGL BERLAKU</th><th width=40>JNS PERMIT</th><th width=80>TGL AGENDA</th><th width=90>AKSI</th></tr>";
	...
	$tampil=mysql_query("select ID_PERMIT,ID_DIPLOMAT,ID_JNS_PERMIT,NO_AGENDA,date_format(TGL_AGENDA,'%d.%m.%Y') as TGL_AGENDA,NO_IZIN_PERMIT,date_format(TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT,date_format(TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,
KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_DIPLOMAT,ST_PERMIT,ST_PERMIT_K,PEKERJAAN,NM_KNT_PERWAKILAN, BENDERA,NEGARA from v_approval_permit where  (negara like '".$neg."%' and NM_DIPLOMAT like '%".$_GET[namadiplomat]."%') and  ST_PERMIT = ".$_GET[status]." order by id_permit desc limit $posisi,$batas ");	 
	
	}
	else
    {$tampil=mysql_query("select ID_PERMIT,ID_DIPLOMAT,ID_JNS_PERMIT,NO_AGENDA,date_format(TGL_AGENDA,'%d.%m.%Y') as TGL_AGENDA,NO_IZIN_PERMIT,date_format(TGL_AWAL_PERMIT,'%d.%m.%Y') as TGL_AWAL_PERMIT,date_format(TGL_AKHIR_PERMIT,'%d.%m.%Y') as TGL_AKHIR_PERMIT,
KET ,NM_JNS_PERMIT,KD_JNS_PERMIT,NM_DIPLOMAT,ST_PERMIT,ST_PERMIT_K,PEKERJAAN,NM_KNT_PERWAKILAN, BENDERA,NEGARA from v_approval_permit where  (negara like '".$neg."%')  and  ST_PERMIT = $_GET[status] order by id_permit desc limit $posisi,$batas ");	
...
/*				<div style=\"color : #B1BF19\"><input type=radio name='ST_PERMIT$noP' value=1 ";
					if ($r[ST_PERMIT]== 1){ echo "checked";}
				echo "> <b>waiting</b> </div><div style=\"color : green\"><input type=radio name='ST_PERMIT$noP' value=2 ";
					if ($r[ST_PERMIT]== 2){ echo "checked";}				
				echo "> <b>approve</b> </div> <div style=\"color : #800000\"> <input type=radio name='ST_PERMIT$noP' value=0 ";
					if ($r[ST_PERMIT]== 0){ echo "checked";}
				echo "> <b>reject</b> </div>
 */		
				echo "<div style=\"color : #B1BF19\"><input type=radio onClick='checkBox(this.value,$noP)' id='ST_PERMIT$noP' name='ST_PERMIT$noP' value=1 ";
					if ($r[ST_PERMIT]== 1){ echo "checked";}
				echo "> <b>waiting</b> </div><div style=\"color : green\"><input type=radio onClick='checkBox(this.value,$noP)' id='ST_PERMIT$noP' name='ST_PERMIT$noP' value=2 ";
					if ($r[ST_PERMIT]== 2){ echo "checked";}				
				echo "> <b>approve</b> </div> <div style=\"color : #800000\"> <input onClick='checkBox(this.value,$noP)' id='ST_PERMIT$noP' type=radio name='ST_PERMIT$noP' value=0 ";
					if ($r[ST_PERMIT]== 0){ echo "checked";}
				echo "> <b>reject</b> </div>";
				...
				echo "<tr>
						<td></td>
						<td></td>
						<td><input type='button' name='updateStatus' onClick=updateAction($r[ID_PERMIT],$noP,'D','1'); value='Submit'></td>
					  </tr>";
...
*/				
    ...
    echo "	<input type=hidden name='jumlahData' value= $noP>     	  
		     </table><div align=right></div>"; //<input type=submit value=Update> </div>
	echo "</form>	";
	
	if (isset($_GET[status])){
		if (isset($_GET[namadiplomat]))
		{
			$jmldata =mysql_num_rows(mysql_query("select ID_PERMIT from v_approval_permit where negara like '".$neg."%' and NM_DIPLOMAT like '%".$_GET[namadiplomat]."%'  and  ST_PERMIT = ".$_GET[status]));
		}else{
			$jmldata =mysql_num_rows(mysql_query("select ID_PERMIT from v_approval_permit where negara like '".$neg."%'  and  ST_PERMIT = ".$_GET[status]));
		}
	}else{
		if (isset($_GET[namadiplomat]))
		{
	...
	if (isset($_GET[status])){
	$ilink = "?module=staypermitD&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]&status=$_GET[status]"; }
	else
	{$ilink = "?module=staypermitD&negara=$_GET[negara]&namadiplomat=$_GET[namadiplomat]"; }
  ...
  case "lihat_stay_permit":
	...
	echo " <input type=button value='Tambah' onclick=location.href='?module=staypermitD&act=tambah_stay_permit&idt=$idt&negara=$_GET[negara]'>
			<table width=100%>
    ...
    while($r=mysql_fetch_array($tampil)){
      echo "<tr><td>$no</td>
                <td><a href=?module=staypermitD&act=edit_stay_permit&idt=$r[ID_PERMIT]&idd=$idt&negara=$_GET[negara]> $r[KD_JNS_PERMIT]</a></td>
				<td>$r[NO_AGENDA]</td>
				<td>$r[TGL_AGENDA]</td>
		...
		if ($r[ST_PERMIT_K] == 2){
			...
			echo "<div style=\"color : #800000\"> <b>rejected</b> </div>";
				...
				>Cetak</a> | 
		            <a href=./aksi_stay_permit.php?module=staypermitD&act=hapus&idt=$r[ID_PERMIT]&idd=$idt&negara=$_GET[negara] onClick=\"return confirm('Apakah Anda benar-benar akan menghapus permit $r[NO_IZIN_PERMIT]?')\">Hapus</a></td>
				</tr>";
  ...
  case "cari":
    ...
    while($r=mysql_fetch_array($tampil)){
		...
		echo "<tr><td>$no</td>
				...
				&nbsp <a href=?module=staypermitD&negara=$r[NEGARA]>$r[NEGARA] </a></td><td>";
