...
if (empty($_SESSION['G_iduser']) AND empty($_SESSION['G_namauser']) AND empty($_SESSION['G_leveluser'])) {
    ...
    ?>
                            ...
                            $('input[name="tambah_anggota_fam"]').click(function () {
                                ...
                                $('.remove-me4').click(function (e) {
                                    ...
                                    //var inputIdg = ".inputIdh" + fieldNum;

                                    var rowIdi = "#rowIdi" + fieldNum;
                                    //var inputIdg = ".inputIdi" + fieldNum;
    ...
    ?>
                            $('input[name="sunting_tambah_anggota_fam"]').click(function () {
                                ...
                                //if(dasaranggotafam != ''){
                                // $('#anggotaFamResultList tr:last').after('<tr id="rowIdg'+next16+'"><td></td><td width="10px;">'+next16+'.</td><td width="50px;"> Nama &nbsp;&nbsp;<td> : &nbsp;<input size=25 class="inputIdg'+next16+'" type="text"  id="inputanggotafam_nama" name="anggota_fam['+next16+'][anggotafam_nama]"><span id="'+next16+'" class="btn btn-danger remove-me16" value="'+next16+'" >  <input type="button" value="x"></span> </td></tr><tr id="rowIdh'+next16+'"><td></td><td width="10px;"></td><td> Foto </td><td>: &nbsp;<input size=25 class="inputIdg'+next16+'" type="file" onchange="validate_fam(this)" id="inputanggotafam_foto" name="userfile['+next16+'][anggotafam_foto]" /></td></tr><tr id="rowIdi'+next16+'"><td></td><td width="10px;"></td><td> Relasi <td>: <select class="inputIdg'+next16+'" name="anggota_fam['+next16+'][anggotafam_relasi]" id="inputanggotafam_relasi"><option>- Silahkan Pilih -</option><option value="suami">Suami</option><option value="istri">Istri</option><option value="anak">Anak</option><option value="orang tua">Orang Tua</option><option value="saudara">Saudara</option></select>  </td></tr><tr id="rowIdj'+next16+'"><td></td><td width="10px;"></td><td> Paspor </td><td>: <input size=25 class="inputIdg'+next16+'" type="text"  id="inputanggotafam_nopaspor" name="anggota_fam['+next16+'][anggotafam_nopaspor]"></td></tr>  <tr id="rowIdk'+next16+'"><td></td><td width="10px;"></td><td></td><td> &nbsp;&nbsp;<input size=25 class="inputIdg'+next16+'" type="file" onchange="validate_fam(this)" id="inputanggotafam_foto_paspor" name="userfile['+next16+'][anggotafam_foto_paspor]" onchange="validate_docdll(this)"></td></tr>');

                                $('#anggotaFamResultList tr:last').after('<tr id="rowIdg' + next16 + '"><td></td><td width="10px;">' + next16 + '.</td><td width="50px;"> Nama &nbsp;&nbsp;<td> : &nbsp;<input size=25 class="inputIdg' + next16 + '" type="text"  id="inputanggotafam_nama" name="anggota_fam[' + next16 + '][anggotafam_nama]"><span id="' + next16 + '" class="btn btn-danger remove-me16" value="' + next16 + '" >  <input type="button" value="x"></span> </td></tr><tr id="rowIdj' + next4 + '"><td></td><td width="10px;"></td><td> Tgl Lahir </td><td>: <input  type="text" id="inputanggotafam_tgllahir" name="anggota_fam[' + next16 + '][anggotafam_tgllahir]"  class="TGL_LAHIR" name="TGL_LAHIR"></td></tr><tr id="rowIdh' + next16 + '"><td></td><td width="10px;"></td><td> Kewarganegaraan <td>: <select class="inputIdg' + next16 + '" name="anggota_fam[' + next16 + '][anggotafam_kewarganegaraan]" id="inputanggotafam_kewarganegaraan"><option>- Silahkan Pilih -</option><?php while ($val = mysql_fetch_array($tampil_wn)) { ?><option value="<?php echo $val[ID_NEGARA]; ?>"><?php echo $val[NEGARA]; ?></option><?php } ?></select>  </td></tr><tr id="rowIdhh' + next16 + '"><td></td><td width="10px;"></td><td> Foto </td><td>: &nbsp;<input size=25 class="inputIdg' + next16 + '" type="file"  id="inputanggotafam_foto" name="userfile[' + next16 + '][anggotafam_foto]" /><ul><li>Pas Photo terbaru (3 bulan terakhir).</li><li>Warna latar pas photo berwarna putih.</li><li>Wajah pada pas photo melihat lurus ke arah kamera.</li><li>Pas photo merupakan close up dari kepala dan bahu sehingga memenuhi 80% dari seluruh photo.</li><li>Mata harus terbuka dan terlihat jelas.</li><li>Tidak ada bagian kepala yang terpotong dan wajah tidak boleh tertutupi ornamen.</li><li>File foto yang diizinkan hanya dalam bentuk .jpg.</li></ul></td></tr><tr id="rowIdi' + next16 + '"><td></td><td width="10px;"></td><td> Relasi <td>: <select class="inputIdg' + next16 + '" name="anggota_fam[' + next16 + '][anggotafam_relasi]" id="inputanggotafam_relasi"><option>- Silahkan Pilih -</option><?php while ($val = mysql_fetch_array($tampil_relasifam)) { ?><option value="<?php echo $val[id]; ?>"><?php echo $val[relasi]; ?></option><?php } ?></select>  </td></tr><tr id="rowIdj' + next16 + '"><td></td><td width="10px;"></td><td> Paspor </td><td>: <input size=25 class="inputIdg' + next16 + '" type="text"  id="inputanggotafam_nopaspor" name="anggota_fam[' + next16 + '][anggotafam_nopaspor]"></td></tr>  <tr id="rowIdk' + next16 + '"><td></td><td width="10px;"></td><td></td><td> &nbsp;&nbsp;<input size=25 class="inputIdg' + next16 + '" type="file"  id="inputanggotafam_foto_paspor" name="userfile[' + next16 + '][anggotafam_foto_paspor]" onchange="validate_docdll(this)"></td></tr>');
                                $(".TGL_LAHIR").datepicker({dateFormat: 'yy-mm-dd'});
                                // $('#anggotaFamResultList1 tr:last').after('<tr id="rowIdg'+next16+'"><td class="inputIdg'+next16+'"></td><td class="inputIdg'+next16+'"></td><td class="inputIdg'+next16+'">'+next16+'. <input readonly size=50 class="inputIdg'+next16+'" type="text"  value="" name="dasar_anggotafam1['+next16+'][dasaranggotafam]"></td></tr>');
						...
						function loadPopupBoxVisa(i,kd,id_negara,nm_negara,deskripsi,sumber,nomor_dok,lokasi_dok,nm_file,sts_aktif) {	// To Load the Popupbox
                            ...
                            //document.getElementById("dokumen_edt").value = nomor_dok;
                         ...
                         for(var i=0;i<as.length;i++){
                                ...
                                //document.getElementById("deskripsi_view").value += "User Input:"+usr_input[i]+("\n");
                                if(tgl_edit[i] !== 'null'){
                                    document.getElementById("deskripsi_view").value += "Tgl. Edit:"+tgl_edit[i]+", User Edit:"+usr_edt[i]+("\n");
                                    //document.getElementById("deskripsi_view").value += "User Edit:"+usr_edt[i]+("\n");
                                }
