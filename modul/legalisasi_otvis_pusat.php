...
<table cellspacing="0" border="0" width=100%>
	...
	<tr>
		...
		<td align="left" valign=bottom><font face="Arial" color="#000000">Tanggal</font></td>
		<td align="left" valign=bottom><font face="Arial" color="#000000">:</font></td>
		<td align="left" valign=bottom><font face="Arial" color="#000000"><?php if($r['tgl_otvis']){echo date('d-m-Y',strtotime($r['tgl_otvis'])); }?></font></td>
	</tr>
	...
	<tr>
		...
		OR ID_JNS_VISA = 26 OR ID_JNS_VISA= 27 OR ID_JNS_VISA= 28";
					...
					{
					echo "<div style='color:red';><i>belum diproses datanya</i></div>";
					}
		?>
	...
	<tr>
		...
		<td align="left" valign=top><font face="Arial" color="#000000">:</font></td>
		<td align="left" colspan=10 valign=bottom><font face="Arial" color="#000000">
		<?php $tampilbeda4=mysql_query("SELECT * FROM tbl_dasarberi_visa where id_otvis = '$id_otvis'");
        $i=1;
		while($r4=mysql_fetch_array($tampilbeda4)){ 
		if($r4[dasar_berivisa])
			{
			echo $i.'. '.$r4[dasar_berivisa].'<br>';
			$i++;
			}
			else
			{
	...
	<tr>
		<td colspan=4 height="20" align="center" valign=bottom><u><font face="Arial" color="#000000"><?php echo $r['verifikator'];?></font></u></td>
		<td align="left" valign=bottom><font face="Arial" color="#000000"><br></font></td>
		<td align="left" valign=bottom><font face="Arial" color="#000000"><br></font></td>
		<td colspan=6 align="center" valign=bottom><u><font face="Arial" color="#000000"><?php echo $r['legalisator'];?></font></u></td>
		</tr>
	<tr>
		<td colspan=4 height="20" align="center" valign=bottom><font face="Arial" color="#000000"><?php echo $r['jabatan_verifikator'];?></font></td>
		<td align="left" valign=bottom><font face="Arial" color="#000000"><br></font></td>
		<td align="left" valign=bottom><font face="Arial" color="#000000"><br></font></td>
		<td colspan=6 align="center" valign=bottom><font face="Arial" color="#000000"><?php echo $r['jabatan_legalisator'];?></font></td>
		</tr>
	<tr>
		<td style="border-bottom: 1px solid #000000" height="20" align="left" valign=bottom><font face="Arial" color="#000000"><br></font></td>
		<td style="border-bottom: 1px solid #000000" align="left" valign=bottom><font face="Arial" color="#000000"><br></font></td>
