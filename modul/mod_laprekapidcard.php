...
switch($_GET[act]){
  ...
  echo "<h2>Laporan Rekapitulasi Permit </h2> 
    <form method=POST action='./deplu.php?module=laprekapijintinggal&act=generate' enctype='multipart/form-data'>
          <table width=80%>
...
if (empty($_SESSION[G_iduser]) AND empty($_SESSION[G_namauser])){
	...
	echo $template;
		...
		<div align=center>
			...
			<h2>BREAK DOWN REKAPITULASI PENERBITAN PERMIT</h2>
			<table>
				<tr>
					<th><?=$TGL_AWAL?> S/D <?=$TGL_AKHIR?></th>
					<th >DIPLOMAT - <br/>DINAS</th>
